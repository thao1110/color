  ...
  grunt.initConfig({
    ...
    concat: Object.assign({}, {
      dist: {
        files: [{
          ...
          '<%= meta.build %>js/libs.js': ['<%= meta.scripts %>libs/jquery-2.1.4.js', '<%= meta.scripts %>libs/handlebars-v4.0.5.js','<%= meta.scripts %>libs/jquery.parallax-1.1.3.js', '<%= meta.scripts %>libs/plugins/*.js'],
    ...
    uglify: {
      ...
      dist: {
        files: [{
          '<%= meta.build %>js/modernizr.js': ['<%= meta.scripts %>libs/modernizr.2.8.3.js', '<%= meta.scripts %>libs/detectizr.js'],
          '<%= meta.build %>js/script.js': ['<%= meta.scripts %>l10n.js', '<%= meta.scripts %>libs/jquery-2.1.4.js', '<%= meta.scripts %>libs/handlebars-v4.0.5.js','<%= meta.scripts %>libs/jquery.parallax-1.1.3.js', '<%= meta.scripts %>libs/plugins/*.js', '<%= meta.scripts %>site.js', '<%= meta.scripts %>plugins/*.js']
        }]
      }
    },
    usemin: {
